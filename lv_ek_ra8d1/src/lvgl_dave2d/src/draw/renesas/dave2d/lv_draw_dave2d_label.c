                                                 ...
                                                 lv_draw_fill_dsc_t * fill_draw_dsc, const lv_area_t * fill_area)
{
    ...
    d2_cliprect(unit->d2_handle, (d2_border)clip_area.x1, (d2_border)clip_area.y1, (d2_border)clip_area.x2, (d2_border)clip_area.y2);
...
//            blend_dsc.mask_res = LV_DRAW_SW_MASK_RES_CHANGED;
...
#endif
#endif
            d2_settexture(unit->d2_handle, (void *)glyph_draw_dsc->bitmap, (d2_s32)lv_draw_buf_width_to_stride((uint32_t)lv_area_get_width(&letter_coords), LV_COLOR_FORMAT_A8),
            ...
            d2_settexturemapping(unit->d2_handle, D2_FIX4(letter_coords.x1), D2_FIX4(letter_coords.y1), D2_FIX16(0), D2_FIX16(0), D2_FIX16(1), D2_FIX16(0), D2_FIX16(0), D2_FIX16(1));
