...
#include "../../../../../lvgl/src/misc/lv_cache.h"
                          ...
                          const lv_area_t * img_coords, const lv_area_t * clipped_img_area)
{
   ...
   // lv_draw_sw_blend_dsc_t blend_dsc;
    ...
    d2_settexture(u->d2_handle, (void *)src_buf, (d2_s32)(decoder_dsc->header.stride/lv_color_format_get_size(header->cf)),
    ...
    if( transformed )
    {
        ...
        /* LV_TRIGO_SHIFT is 15, so only need to shift by 1 to get 16:16 fixed point */
         dxu = (d2_s32)((1 << 1) * cos_xu); /* TODO - Need to handle scaling of the texture based on draw_dsc->scale_x, draw_dsc->scale_y, currently no scaling it is 1:1 */
