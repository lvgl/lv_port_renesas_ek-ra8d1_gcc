    ...
    if (LV_GRAD_DIR_NONE != dsc->grad.dir)
    {
        ...
        if ( LV_GRAD_DIR_VER == dsc->grad.dir)
        {
             ...
             else
             {
              ...
              d2_setalphagradient(u->d2_handle, 0, (d2_point)D2_FIX4(0),  (d2_point)D2_FIX4(y0_i), (d2_point)D2_FIX4(0), (d2_point)D2_FIX4((y3_i - y0_i)) );
        }
        else if (LV_GRAD_DIR_HOR == dsc->grad.dir)
        {
           ...
           else
           {
            ...
            d2_setalphagradient(u->d2_handle, 0, (d2_point)D2_FIX4(x0_i),  (d2_point)D2_FIX4(0), (d2_point)D2_FIX4(x3_i - x0_i), (d2_point)D2_FIX4((0)) );
        }
