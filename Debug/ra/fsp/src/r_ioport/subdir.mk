...
ra/fsp/src/r_ioport/%.o: ../ra/fsp/src/r_ioport/%.c ra/fsp/src/r_ioport/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_ioport

clean-ra-2f-fsp-2f-src-2f-r_ioport:
	-$(RM) ./ra/fsp/src/r_ioport/r_ioport.d ./ra/fsp/src/r_ioport/r_ioport.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_ioport
