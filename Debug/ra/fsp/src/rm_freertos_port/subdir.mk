...
ra/fsp/src/rm_freertos_port/%.o: ../ra/fsp/src/rm_freertos_port/%.c ra/fsp/src/rm_freertos_port/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-rm_freertos_port

clean-ra-2f-fsp-2f-src-2f-rm_freertos_port:
	-$(RM) ./ra/fsp/src/rm_freertos_port/port.d ./ra/fsp/src/rm_freertos_port/port.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-rm_freertos_port
