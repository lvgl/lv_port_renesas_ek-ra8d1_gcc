...
ra/fsp/src/r_mipi_phy/%.o: ../ra/fsp/src/r_mipi_phy/%.c ra/fsp/src/r_mipi_phy/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_mipi_phy

clean-ra-2f-fsp-2f-src-2f-r_mipi_phy:
	-$(RM) ./ra/fsp/src/r_mipi_phy/r_mipi_phy.d ./ra/fsp/src/r_mipi_phy/r_mipi_phy.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_mipi_phy
