...
ra/fsp/src/r_ospi_b/%.o: ../ra/fsp/src/r_ospi_b/%.c ra/fsp/src/r_ospi_b/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_ospi_b

clean-ra-2f-fsp-2f-src-2f-r_ospi_b:
	-$(RM) ./ra/fsp/src/r_ospi_b/r_ospi_b.d ./ra/fsp/src/r_ospi_b/r_ospi_b.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_ospi_b
