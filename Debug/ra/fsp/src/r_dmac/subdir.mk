...
ra/fsp/src/r_dmac/%.o: ../ra/fsp/src/r_dmac/%.c ra/fsp/src/r_dmac/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_dmac

clean-ra-2f-fsp-2f-src-2f-r_dmac:
	-$(RM) ./ra/fsp/src/r_dmac/r_dmac.d ./ra/fsp/src/r_dmac/r_dmac.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_dmac
