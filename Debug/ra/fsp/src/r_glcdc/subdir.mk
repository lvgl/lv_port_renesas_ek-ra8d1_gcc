...
ra/fsp/src/r_glcdc/%.o: ../ra/fsp/src/r_glcdc/%.c ra/fsp/src/r_glcdc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_glcdc

clean-ra-2f-fsp-2f-src-2f-r_glcdc:
	-$(RM) ./ra/fsp/src/r_glcdc/r_glcdc.d ./ra/fsp/src/r_glcdc/r_glcdc.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_glcdc
