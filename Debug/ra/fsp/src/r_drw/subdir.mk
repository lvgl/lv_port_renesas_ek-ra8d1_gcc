...
ra/fsp/src/r_drw/%.o: ../ra/fsp/src/r_drw/%.c ra/fsp/src/r_drw/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-ra-2f-fsp-2f-src-2f-r_drw

clean-ra-2f-fsp-2f-src-2f-r_drw:
	-$(RM) ./ra/fsp/src/r_drw/r_drw_base.d ./ra/fsp/src/r_drw/r_drw_base.o ./ra/fsp/src/r_drw/r_drw_irq.d ./ra/fsp/src/r_drw/r_drw_irq.o ./ra/fsp/src/r_drw/r_drw_memory.d ./ra/fsp/src/r_drw/r_drw_memory.o

.PHONY: clean-ra-2f-fsp-2f-src-2f-r_drw
