...
C_SRCS += \
../src/lvgl/src/layouts/lv_layout.c 

C_DEPS += \
./src/lvgl/src/layouts/lv_layout.d 

OBJS += \
./src/lvgl/src/layouts/lv_layout.o 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/src/layouts/%.o: ../src/lvgl/src/layouts/%.c src/lvgl/src/layouts/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-layouts

clean-src-2f-lvgl-2f-src-2f-layouts:
	-$(RM) ./src/lvgl/src/layouts/lv_layout.d ./src/lvgl/src/layouts/lv_layout.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-layouts
