...
C_DEPS += \
./src/lvgl/src/layouts/flex/lv_flex.d 
...
src/lvgl/src/layouts/flex/%.o: ../src/lvgl/src/layouts/flex/%.c src/lvgl/src/layouts/flex/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-layouts-2f-flex

clean-src-2f-lvgl-2f-src-2f-layouts-2f-flex:
	-$(RM) ./src/lvgl/src/layouts/flex/lv_flex.d ./src/lvgl/src/layouts/flex/lv_flex.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-layouts-2f-flex
