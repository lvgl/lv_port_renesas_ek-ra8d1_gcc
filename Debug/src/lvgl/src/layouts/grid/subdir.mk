...
C_DEPS += \
./src/lvgl/src/layouts/grid/lv_grid.d 
...
src/lvgl/src/layouts/grid/%.o: ../src/lvgl/src/layouts/grid/%.c src/lvgl/src/layouts/grid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-layouts-2f-grid

clean-src-2f-lvgl-2f-src-2f-layouts-2f-grid:
	-$(RM) ./src/lvgl/src/layouts/grid/lv_grid.d ./src/lvgl/src/layouts/grid/lv_grid.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-layouts-2f-grid
