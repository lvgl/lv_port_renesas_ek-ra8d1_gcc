...
S_UPPER_SRCS += \
../src/lvgl/src/draw/sw/blend/helium/lv_blend_helium.S 

OBJS += \
./src/lvgl/src/draw/sw/blend/helium/lv_blend_helium.o 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/src/draw/sw/blend/helium/%.o: ../src/lvgl/src/draw/sw/blend/helium/%.S src/lvgl/src/draw/sw/blend/helium/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-draw-2f-sw-2f-blend-2f-helium

clean-src-2f-lvgl-2f-src-2f-draw-2f-sw-2f-blend-2f-helium:
	-$(RM) ./src/lvgl/src/draw/sw/blend/helium/lv_blend_helium.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-draw-2f-sw-2f-blend-2f-helium
