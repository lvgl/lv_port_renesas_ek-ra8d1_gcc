...
src/lvgl/src/draw/sdl/%.o: ../src/lvgl/src/draw/sdl/%.c src/lvgl/src/draw/sdl/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-draw-2f-sdl

clean-src-2f-lvgl-2f-src-2f-draw-2f-sdl:
	-$(RM) ./src/lvgl/src/draw/sdl/lv_draw_sdl.d ./src/lvgl/src/draw/sdl/lv_draw_sdl.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-draw-2f-sdl
