...
C_DEPS += \
./src/lvgl/src/widgets/button/lv_button.d 
...
src/lvgl/src/widgets/button/%.o: ../src/lvgl/src/widgets/button/%.c src/lvgl/src/widgets/button/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-widgets-2f-button

clean-src-2f-lvgl-2f-src-2f-widgets-2f-button:
	-$(RM) ./src/lvgl/src/widgets/button/lv_button.d ./src/lvgl/src/widgets/button/lv_button.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-widgets-2f-button
