...
C_SRCS += \
../src/lvgl/src/widgets/bar/lv_bar.c 

C_DEPS += \
./src/lvgl/src/widgets/bar/lv_bar.d 

OBJS += \
./src/lvgl/src/widgets/bar/lv_bar.o 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/src/widgets/bar/%.o: ../src/lvgl/src/widgets/bar/%.c src/lvgl/src/widgets/bar/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-src-2f-widgets-2f-bar

clean-src-2f-lvgl-2f-src-2f-widgets-2f-bar:
	-$(RM) ./src/lvgl/src/widgets/bar/lv_bar.d ./src/lvgl/src/widgets/bar/lv_bar.o

.PHONY: clean-src-2f-lvgl-2f-src-2f-widgets-2f-bar
