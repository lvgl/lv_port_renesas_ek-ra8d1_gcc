...
src/lvgl/examples/layouts/flex/%.o: ../src/lvgl/examples/layouts/flex/%.c src/lvgl/examples/layouts/flex/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-examples-2f-layouts-2f-flex

clean-src-2f-lvgl-2f-examples-2f-layouts-2f-flex:
	-$(RM) ./src/lvgl/examples/layouts/flex/lv_example_flex_1.d ./src/lvgl/examples/layouts/flex/lv_example_flex_1.o ./src/lvgl/examples/layouts/flex/lv_example_flex_2.d ./src/lvgl/examples/layouts/flex/lv_example_flex_2.o ./src/lvgl/examples/layouts/flex/lv_example_flex_3.d ./src/lvgl/examples/layouts/flex/lv_example_flex_3.o ./src/lvgl/examples/layouts/flex/lv_example_flex_4.d ./src/lvgl/examples/layouts/flex/lv_example_flex_4.o ./src/lvgl/examples/layouts/flex/lv_example_flex_5.d ./src/lvgl/examples/layouts/flex/lv_example_flex_5.o ./src/lvgl/examples/layouts/flex/lv_example_flex_6.d ./src/lvgl/examples/layouts/flex/lv_example_flex_6.o

.PHONY: clean-src-2f-lvgl-2f-examples-2f-layouts-2f-flex
