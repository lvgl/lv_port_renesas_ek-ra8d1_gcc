...
src/lvgl/examples/layouts/grid/%.o: ../src/lvgl/examples/layouts/grid/%.c src/lvgl/examples/layouts/grid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-examples-2f-layouts-2f-grid

clean-src-2f-lvgl-2f-examples-2f-layouts-2f-grid:
	-$(RM) ./src/lvgl/examples/layouts/grid/lv_example_grid_1.d ./src/lvgl/examples/layouts/grid/lv_example_grid_1.o ./src/lvgl/examples/layouts/grid/lv_example_grid_2.d ./src/lvgl/examples/layouts/grid/lv_example_grid_2.o ./src/lvgl/examples/layouts/grid/lv_example_grid_3.d ./src/lvgl/examples/layouts/grid/lv_example_grid_3.o ./src/lvgl/examples/layouts/grid/lv_example_grid_4.d ./src/lvgl/examples/layouts/grid/lv_example_grid_4.o ./src/lvgl/examples/layouts/grid/lv_example_grid_5.d ./src/lvgl/examples/layouts/grid/lv_example_grid_5.o ./src/lvgl/examples/layouts/grid/lv_example_grid_6.d ./src/lvgl/examples/layouts/grid/lv_example_grid_6.o

.PHONY: clean-src-2f-lvgl-2f-examples-2f-layouts-2f-grid
