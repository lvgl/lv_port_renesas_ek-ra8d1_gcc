...
C_DEPS += \
./src/lvgl/examples/libs/barcode/lv_example_barcode_1.d 
...
src/lvgl/examples/libs/barcode/%.o: ../src/lvgl/examples/libs/barcode/%.c src/lvgl/examples/libs/barcode/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-examples-2f-libs-2f-barcode

clean-src-2f-lvgl-2f-examples-2f-libs-2f-barcode:
	-$(RM) ./src/lvgl/examples/libs/barcode/lv_example_barcode_1.d ./src/lvgl/examples/libs/barcode/lv_example_barcode_1.o

.PHONY: clean-src-2f-lvgl-2f-examples-2f-libs-2f-barcode
