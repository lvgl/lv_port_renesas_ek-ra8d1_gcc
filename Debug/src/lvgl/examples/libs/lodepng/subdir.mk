...
../src/lvgl/examples/libs/lodepng/lv_example_lodepng_1.c 

C_DEPS += \
./src/lvgl/examples/libs/lodepng/img_wink_png.d \
./src/lvgl/examples/libs/lodepng/lv_example_lodepng_1.d 

OBJS += \
./src/lvgl/examples/libs/lodepng/img_wink_png.o \
./src/lvgl/examples/libs/lodepng/lv_example_lodepng_1.o 


# Each subdirectory must supply rules for building sources it contributes
src/lvgl/examples/libs/lodepng/%.o: ../src/lvgl/examples/libs/lodepng/%.c src/lvgl/examples/libs/lodepng/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-examples-2f-libs-2f-lodepng

clean-src-2f-lvgl-2f-examples-2f-libs-2f-lodepng:
	-$(RM) ./src/lvgl/examples/libs/lodepng/img_wink_png.d ./src/lvgl/examples/libs/lodepng/img_wink_png.o ./src/lvgl/examples/libs/lodepng/lv_example_lodepng_1.d ./src/lvgl/examples/libs/lodepng/lv_example_lodepng_1.o

.PHONY: clean-src-2f-lvgl-2f-examples-2f-libs-2f-lodepng
