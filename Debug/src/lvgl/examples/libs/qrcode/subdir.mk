...
C_DEPS += \
./src/lvgl/examples/libs/qrcode/lv_example_qrcode_1.d 
...
src/lvgl/examples/libs/qrcode/%.o: ../src/lvgl/examples/libs/qrcode/%.c src/lvgl/examples/libs/qrcode/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lvgl-2f-examples-2f-libs-2f-qrcode

clean-src-2f-lvgl-2f-examples-2f-libs-2f-qrcode:
	-$(RM) ./src/lvgl/examples/libs/qrcode/lv_example_qrcode_1.d ./src/lvgl/examples/libs/qrcode/lv_example_qrcode_1.o

.PHONY: clean-src-2f-lvgl-2f-examples-2f-libs-2f-qrcode
