...
C_SRCS += \
../src/Arm-2D/Library/template/arm_2d_user_opcode_template_i_cp_src.c 

C_DEPS += \
./src/Arm-2D/Library/template/arm_2d_user_opcode_template_i_cp_src.d 

OBJS += \
./src/Arm-2D/Library/template/arm_2d_user_opcode_template_i_cp_src.o 


# Each subdirectory must supply rules for building sources it contributes
src/Arm-2D/Library/template/%.o: ../src/Arm-2D/Library/template/%.c src/Arm-2D/Library/template/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-Arm-2d-2D-2f-Library-2f-template

clean-src-2f-Arm-2d-2D-2f-Library-2f-template:
	-$(RM) ./src/Arm-2D/Library/template/arm_2d_user_opcode_template_i_cp_src.d ./src/Arm-2D/Library/template/arm_2d_user_opcode_template_i_cp_src.o

.PHONY: clean-src-2f-Arm-2d-2D-2f-Library-2f-template
