...
#define BSP_CFG_PLL_FREQUENCY_HZ (1920000000) /* PLL 1920000000Hz */
#define BSP_CFG_PLODIVP (BSP_CLOCKS_PLL_DIV_2) /* PLL1P Div /2 */
#define BSP_CFG_PLL1P_FREQUENCY_HZ (960000000) /* PLL1P 960000000Hz */
#define BSP_CFG_PLODIVQ (BSP_CLOCKS_PLL_DIV_6) /* PLL1Q Div /6 */
#define BSP_CFG_PLL1Q_FREQUENCY_HZ (320000000) /* PLL1Q 320000000Hz */
#define BSP_CFG_PLODIVR (BSP_CLOCKS_PLL_DIV_6) /* PLL1R Div /6 */
#define BSP_CFG_PLL1R_FREQUENCY_HZ (320000000) /* PLL1R 320000000Hz */
...
#define BSP_CFG_PLL2_FREQUENCY_HZ (1920000000) /* PLL2 1920000000Hz */
...
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (240000000) /* PLL2Q 240000000Hz */
...
#define BSP_CFG_SPICLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_LOCO) /* SPICLK Src: LOCO */
...
#define BSP_CFG_OCTA_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2P) /* OCTASPICLK Src: PLL2P */
...
#define BSP_CFG_LCDCLK_DIV (BSP_CLOCKS_LCD_CLOCK_DIV_1) /* LCDCLK Div /1 */
...
#define BSP_CFG_OCTA_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_2) /* OCTASPICLK Div /2 */
