...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_00_PIN_02,
		.pin_cfg = ((uint32_t) IOPORT_CFG_ANALOG_ENABLE) },
		{ .pin = BSP_IO_PORT_00_PIN_03, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				BSP_IO_PORT_00_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				BSP_IO_PORT_00_PIN_05, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				BSP_IO_PORT_00_PIN_07, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				BSP_IO_PORT_00_PIN_11, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				BSP_IO_PORT_00_PIN_14, .pin_cfg =
				((uint32_t) IOPORT_CFG_ANALOG_ENABLE) }, { .pin =
				...
				BSP_IO_PORT_01_PIN_12, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_01_PIN_13, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_01_PIN_14, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_01_PIN_15, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_02_PIN_06, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_MIPI) }, { .pin =
				BSP_IO_PORT_02_PIN_08, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
				...
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_01, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_02, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_03, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				...
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_11, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_03_PIN_12, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_04_PIN_00, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CEU) }, { .pin =
				...
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CEU) }, { .pin =
				BSP_IO_PORT_05_PIN_00, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_USB_FS) }, { .pin =
				BSP_IO_PORT_05_PIN_01, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_USB_FS) }, { .pin =
				BSP_IO_PORT_05_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_05_PIN_05, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_05_PIN_06, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_05_PIN_07, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_05_PIN_10, .pin_cfg =
				...
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_03, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_05, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_06, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_07, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_09, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				...
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_11, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_06_PIN_12, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				...
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_07_PIN_08, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CEU) }, { .pin =
				BSP_IO_PORT_07_PIN_09, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CEU) }, { .pin =
				BSP_IO_PORT_07_PIN_10, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_CEU) }, { .pin =
				BSP_IO_PORT_08_PIN_00, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_01, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_02, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_03, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_08, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_OSPI) }, { .pin =
				BSP_IO_PORT_08_PIN_09, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_08_PIN_10, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_08_PIN_11, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_08_PIN_13, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_08_PIN_14, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_USB_FS) }, { .pin =
				BSP_IO_PORT_08_PIN_15, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_USB_FS) }, { .pin =
				BSP_IO_PORT_09_PIN_05, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_09_PIN_06, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_09_PIN_07, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_09_PIN_08, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_09_PIN_09, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_10_PIN_00, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_10_PIN_01, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_10_PIN_02, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI0_2_4_6_8) }, { .pin =
				BSP_IO_PORT_10_PIN_03, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI0_2_4_6_8) }, { .pin =
				BSP_IO_PORT_10_PIN_04, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI0_2_4_6_8) }, { .pin =
				BSP_IO_PORT_10_PIN_05, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI0_2_4_6_8) }, { .pin =
				BSP_IO_PORT_10_PIN_06, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_10_PIN_07, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_10_PIN_08, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_10_PIN_09, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_10_PIN_10, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_HIGH
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_BUS) }, { .pin =
				BSP_IO_PORT_10_PIN_11, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) }, { .pin =
				BSP_IO_PORT_10_PIN_13, .pin_cfg =
				((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
						| (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) }, { .pin =
				BSP_IO_PORT_10_PIN_14, .pin_cfg =
				((uint32_t) IOPORT_CFG_DRIVE_MID
						| (uint32_t) IOPORT_CFG_PERIPHERAL_PIN
						| (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) }, { .pin =
				BSP_IO_PORT_10_PIN_15, .pin_cfg =
				((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
