...
#define DISPLAY_BITS_PER_PIXEL_INPUT1 (32)
            ...
            #endif
#define DISPLAY_HSIZE_INPUT1                 (20)
#define DISPLAY_VSIZE_INPUT1                 (85)
...
extern SemaphoreHandle_t g_reset_binary_semaphore;
extern SemaphoreHandle_t g_irq_binary_semaphore;
extern SemaphoreHandle_t g_iic_binary_semaphore;
...
extern SemaphoreHandle_t glcdc_update_complete;
